...
| `guest_common_group_gid` | `31001` | A gid of the group name of the common group, which all guest users are member of (make sure this ID is and will be really available) |
